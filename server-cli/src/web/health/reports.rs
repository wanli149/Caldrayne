...
pub(in crate::web) struct RuntimeObservabilityEntryReport {
    ...
    pub(in crate::web) state: &'static str,
    pub(in crate::web) detail: String,
    pub(in crate::web) recent_abnormal_count: Option<usize>,
    pub(in crate::web) latest_chunk_key: Option<[i32; 2]>,
    pub(in crate::web) latest_terminal: Option<&'static str>,
    pub(in crate::web) latest_tick: Option<u64>,
    ...
    pub(in crate::web) managed_recipe_sidecar_missing: Option<bool>,
...
pub(in crate::web) struct PreflightReviewDecisionContract {
    ...
    pub(in crate::web) current_result_status_hint: Option<&'static str>,
    pub(in crate::web) current_terminal_record_fields: Vec<&'static str>,
    pub(in crate::web) required_archive_receipt_fields_when_terminal: Vec<&'static str>,
    pub(in crate::web) required_post_archive_writeback_fields_after_archive: Vec<&'static str>,
    pub(in crate::web) required_archive_correlation_dimensions_when_terminal: Vec<&'static str>,
    pub(in crate::web) same_section_archive_receipt_required: bool,
    pub(in crate::web) same_section_post_archive_verification_required: bool,
