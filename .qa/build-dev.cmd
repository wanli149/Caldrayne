...
set "CARGO_TARGET_DIR=%CALDRAYNE_ROOT%\.qa\build\dev\target"
"%CARGO_EXE%" rustc -p veldr-voxygen --bin caldrayne --no-default-features --features "default-dev,hot-reloading,shaderc-from-source,egui-ui" -- -C link-arg=/DEBUG:NONE
