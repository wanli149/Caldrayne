...
set "CARGO_TARGET_DIR=J:\Caldrayne\.qa\build\dev\target"
"%CARGO_EXE%" rustc -p veloren-voxygen --bin veloren-voxygen --no-default-features --features "default-dev,hot-reloading,shaderc-from-source,egui-ui" -- -C link-arg=/DEBUG:NONE
