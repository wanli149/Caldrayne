...
image_ids_ice! {
    struct Imgs {
        <ImageGraphic>
        v_logo: "veldr.element.v_logo",
        bg: "veldr.background.bg_main",
        banner_top: "veldr.element.ui.generic.frames.banner_top",
        banner_gradient_bottom: "veldr.element.ui.generic.frames.banner_gradient_bottom",
        ...
        input_bg: "veldr.element.ui.generic.textbox",
        loading_art: "veldr.element.ui.generic.frames.loading_screen.loading_bg",
        loading_art_l: "veldr.element.ui.generic.frames.loading_screen.loading_bg_l",
        loading_art_r: "veldr.element.ui.generic.frames.loading_screen.loading_bg_r",
        ...
        unlock: "veldr.element.ui.generic.buttons.unlock",
        unlock_hover: "veldr.element.ui.generic.buttons.unlock_hover",
        unlock_press: "veldr.element.ui.generic.buttons.unlock_press",
    }
}

// Randomly loaded background images
const BG_IMGS: [&str; 41] = [
    "veldr.background.bg_1",
    "veldr.background.bg_2",
    "veldr.background.bg_3",
    "veldr.background.bg_4",
    "veldr.background.bg_5",
    "veldr.background.bg_6",
    "veldr.background.bg_7",
    "veldr.background.bg_8",
    "veldr.background.bg_9",
    "veldr.background.bg_10",
    "veldr.background.bg_11",
    "veldr.background.bg_12",
    "veldr.background.bg_13",
    "veldr.background.bg_14",
    "veldr.background.bg_15",
    "veldr.background.bg_16",
    "veldr.background.bg_17",
    "veldr.background.bg_18",
    "veldr.background.bg_19",
    "veldr.background.bg_20",
    "veldr.background.bg_21",
    "veldr.background.bg_22",
    "veldr.background.bg_23",
    "veldr.background.bg_24",
    "veldr.background.bg_25",
    "veldr.background.bg_26",
    "veldr.background.bg_27",
    "veldr.background.bg_28",
    "veldr.background.bg_29",
    "veldr.background.bg_30",
    "veldr.background.bg_31",
    "veldr.background.bg_32",
    "veldr.background.bg_33",
    "veldr.background.bg_34",
    "veldr.background.bg_35",
    "veldr.background.bg_36",
    "veldr.background.bg_37",
    "veldr.background.bg_38",
    "veldr.background.bg_39",
    "veldr.background.bg_40",
    "veldr.background.bg_41",
];
