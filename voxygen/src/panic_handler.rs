...
pub fn set_panic_hook(log_filename: String, logs_dir: PathBuf) {
    ...
    panic::set_hook(Box::new(move |panic_info| {
        ...
        if let Some(potential_cause) = potential_cause {
            ...
            reporting this problem. To do this, open an issue on the Caldrayne issue tracker:\n\
            \n\
            https://github.com/wanli149/Caldrayne/issues/new\n\
            \n\
            Please include your crash details in that report so the Caldrayne project can investigate the issue.
            \n\
            ...
            \n\
            The Caldrayne Online client has logged information about the problem (including this \
        ...
        error!(
            "CALDRAYNE ONLINE CLIENT HAS PANICKED\n\n{}\n\nBacktrace:\n{:?}",
            dialog_message,
        ...
        #[cfg(feature = "native-dialog")]
        {
            ...
            let mbox = move || {
                DialogBuilder::message()
                    ...
                    .set_title("Caldrayne Online has crashed!")
