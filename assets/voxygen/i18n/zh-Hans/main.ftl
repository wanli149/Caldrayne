...
main-notice =
    ...
    - 卡德雷恩 Online 构建在 Veloren 开源基础之上。我们会保留必要的上游署名与许可证信息，同时逐步建立自己的品牌与内容方向。

    - 本项目依然遵循开源协作方式。贡献时请保留必要的上游许可证、署名与致谢信息。

    - 出于兼容性考虑，当前部分内部模块、资源键与工程标识仍可能保留历史 `veloren` 命名。
...
loading-tips =
    ...
    .a14 = Caldrayne Online 仍处于 Pre-Alpha 阶段. 我们每天都在努力改进它!
    .a15 = 如果您想参与开发或提交反馈,请访问我们的 GitHub 仓库.
