...
main-tip = İpucu:
main-notice =
    Caldrayne Online Alfa sürümüne hoşgeldin!
    ...
    - Caldrayne Online kar gütmeyen bir topluluk projesidir ve üzerinde çalışan herkes birer gönüllüdür.
    ...
    ~ Caldrayne Online Geliştiricileri
main-login_process =
    Multiplayer note:
