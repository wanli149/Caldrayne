...
main-notice =
    Witaj w wersji alfa Caldrayne Online!
    ...
    - Caldrayne Online jest projektem non-profit, w całości tworzonym przez wolontariuszy w wolnym czasie.
    Jeśli polubisz Caldrayne Online, zapraszamy cię do dołączenia do naszego zespołu! Nowi programiści, artyści, tłumacze i inni są zawsze mile widziani!

    Dziękujemy za przeczytanie tej notki i życzymy miłej gry!

    ~ Zespół Twórców Caldrayne Online
main-login_process =
    Multiplayer note:
