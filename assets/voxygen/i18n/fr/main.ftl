...
main-notice =
    ...
    - Si vous avez des retours constructifs ou avez trouvé un bug, vous pouvez nous contacter via sur notre dépôt GitHub et sur notre serveur Discord ou Matrix.
