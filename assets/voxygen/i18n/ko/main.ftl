...
main-notice =
    Caldrayne Online 알파 버전에 오신 것을 환영합니다!

    게임을 즐기시기 전에 다음 사항들을 꼭 참고해 주세요:

    - 지금은 매우 초기 단계의 알파 버전입니다. 버그가 많고, 게임플레이가 매우 미완성 상태이며, 시스템과 기능들도 다듬어지지 않았거나 아예 없는 경우도 많습니다.

    - 건설적인 피드백이나 버그 제보가 있다면 GitHub 저장소를 통해 알려주세요.

    - Caldrayne Online은 오픈소스 프로젝트입니다. GNU 일반 공중 사용 허가서 버전 3에 따라 자유롭게 게임을 플레이, 수정, 재배포하실 수 있습니다.

    - Caldrayne Online은 비영리 커뮤니티 프로젝트이며, 참여하는 모든 사람들은 자원봉사자입니다.
...
loading-tips =
    ...
    .a14 = Caldrayne Online은 아직 프리알파 단계이며, 우리는 매일 더 나아지도록 노력하고 있습니다!
    .a15 = 개발에 참여하거나 피드백을 공유하고 싶다면 GitHub 저장소를 방문해 주세요.
