...
main-notice =
    ...
    - Якщо у Вас є конструктивна критика, відгуки, поради або Ви знайшли помилки - можете зв'язатись з нами на нашому репозиторії GitHub чи Discord або Matrix сервері.
