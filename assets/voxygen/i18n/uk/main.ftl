...
main-notice =
    Вітаємо в альфа-версії Caldrayne Online!
    ...
    - Якщо у Вас є конструктивні відгуки, поради або Ви знайшли помилку, скористайтеся нашим репозиторієм GitHub.

    - Caldrayne Online - це проект з відкритим кодом. Ви можете вільно грати, змінювати та поширювати гру відповідно до версії 3 загальнодоступної ліцензії GNU.

    - Caldrayne Online - це неприбутковий проект, і всі, хто над ним працюють - волонтери.
...
loading-tips =
    ...
    .a14 = Caldrayne Online все ще на стадії ранньої альфи. Ми стараємося кожного дня щоб робити покращення!
    .a15 = Якщо Ви хочете допомогти розробці або поділитися відгуком, відвідайте наш репозиторій GitHub.
