...
main-notice =
    ...
    - Si tienes críticas constructivas o reportes de errores, puedes contactar con nosotros en nuestro repositorio de GitHub, o en nuestro servidor de Discord o de Matrix.
