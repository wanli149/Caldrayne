...
# Sword abilities
veldr-core-pseudo_abilities-sword-heavy_stance = Tung hållning
    .desc = Attacker i denna hållning kan göra att fiender vacklar och ge mer skada på vacklande fiender men är långsammare.
veldr-core-pseudo_abilities-sword-agile_stance = Smidig hållning
    .desc = Attacker är snabbare men svagare i denna hållning.
veldr-core-pseudo_abilities-sword-defensive_stance = Defensiv hållning
    .desc = Attacker i denna hållning kan användas som en svag blockering eller parering.
veldr-core-pseudo_abilities-sword-crippling_stance = Förlamande hållning
    .desc = Attacker i denna hållning skapar eller förvärrar varaktiga skador.
veldr-core-pseudo_abilities-sword-cleaving_stance = Klyvande hållning
    .desc = Attacker i denna hållning kan träffa flera fiender.
veldr-core-pseudo_abilities-sword-double_slash = Dubbelhugg
...
veldr-core-pseudo_abilities-sword-secondary_ability = Sekundär svärdförmåga
...
veldr-core-pseudo_abilities-sword-crescent_slash = Halvmåneshugg
    .desc =
...
veldr-core-pseudo_abilities-sword-fell_strike = Dödligt hugg
    .desc =
...
veldr-core-pseudo_abilities-sword-skewer = Spetsning
    .desc =
...
veldr-core-pseudo_abilities-sword-cascade = Kaskad
    .desc =
...
veldr-core-pseudo_abilities-sword-cross_cut = Korshugg
    .desc =
...
veldr-core-pseudo_abilities-sword-finisher = Avslutare
    .desc =
