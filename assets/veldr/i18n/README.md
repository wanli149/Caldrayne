...
# Adding a new language in Caldrayne Online

To add a new language in this repository, please follow these steps:
- Create a new folder into the `assets/veldr/i18n` directory
