...
main-tip = Tip:
main-notice =
    Vítejte v alfa verzi Caldrayne Onlineu!
    ...
    - Caldrayne Online je neziskový projekt, kde je každý spolupracující člověk dobrovolníkem.Pokud se vám tato hra líbí, připojte se k našemu týmu!

    Děkujeme za přečtení této zprávy a doufáme, že se vám tato hra bude líbit!

    ~ Tvůrci Caldrayne Online
main-login_process =
    Multiplayer note:
