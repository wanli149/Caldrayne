...
main-tip = ヒント:
main-notice =
    Caldrayne Onlineアルファ版へようこそ！

    楽しいゲームへ飛び込む前に、いくつか注意事項があります。

    - このゲームは、非常に開発初期状態のアルファ版ゲームです。バグ、極めて未完成なゲーム性、洗練されていない操作性、不足している機能が予想されます。

    - 建設的なフィードバックやバグ報告は、GitHub リポジトリからお寄せください。

    - Caldrayne OnlineはGPL 3のオープンソースライセンスの下に提供されています。つまり、あなたはゲームを自由に遊んだり、改造したりコピーできます
     （派生した作品もGPL 3の下ならばという条件でです）

    - Caldrayne Onlineは非営利のコミュニティプロジェクトで、作業をしている人も全員、無償のボランティアです。
    気に入ったなら、開発チームやアートチームにぜひご参加ください。

    このお知らせを読んでいただき、ありがとうございます。それではゲームを楽しんでください！

    ~ Caldrayne Online開発チームより
main-login_process =
    Multiplayer note:
...
loading-tips =
    ...
    .a14 = Caldrayne Onlineは、まだアルファ版です。私たちは日々、改善のためにベストを尽くしています！
    .a15 = 開発に参加したい方やフィードバックを共有したい方は、GitHub リポジトリをご覧ください。
