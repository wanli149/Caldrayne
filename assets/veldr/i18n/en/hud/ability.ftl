...
## Sword abilities
veldr-core-pseudo_abilities-sword-heavy_stance = Heavy Stance
    .desc = Attacks in this stance can stagger enemies and deal more damage to staggered enemies but are slower.
veldr-core-pseudo_abilities-sword-agile_stance = Agile Stance
    .desc = Attacks are faster but weaker in this stance.
veldr-core-pseudo_abilities-sword-defensive_stance = Defensive Stance
    .desc = Attacks in this stance can act as either a weak block or a parry.
veldr-core-pseudo_abilities-sword-crippling_stance = Crippling Stance
    .desc = Attacks in this stance create or worsen lasting injuries.
veldr-core-pseudo_abilities-sword-cleaving_stance = Cleaving Stance
    .desc = Attacks in this stance can hit multiple enemies.
veldr-core-pseudo_abilities-sword-double_slash = Double Slash
...
veldr-core-pseudo_abilities-sword-secondary_ability = Secondary Sword Ability
...
veldr-core-pseudo_abilities-sword-crescent_slash = Crescent Slash
    .desc =
...
veldr-core-pseudo_abilities-sword-fell_strike = Fell Strike
    .desc =
...
veldr-core-pseudo_abilities-sword-skewer = Skewer
    .desc =
        A stabbing lunge.
        This skill changes depending on your adopted stance.
...
veldr-core-pseudo_abilities-sword-cross_cut = Cross Cut
    .desc =
...
veldr-core-pseudo_abilities-sword-finisher = Finisher
    .desc =
