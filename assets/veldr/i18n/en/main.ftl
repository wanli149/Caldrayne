...
main-notice =
    ...
    - Caldrayne Online is derived from the Veloren open-source foundation. We are preserving required upstream credit while building a distinct branded project.
    ...
    - The current project is still under active development, and some internal modules, resource keys, and engineering identifiers may retain historical legacy naming while the branding work is completed.
...
main-singleplayer-provenance = Historical source: { $source }
main-singleplayer-provenance-legacy_unknown = legacy world; original source unavailable
main-singleplayer-provenance-legacy_migrated = migrated legacy world; original source unavailable
main-singleplayer-provenance-load_path = strict world file "{ $name }"
main-singleplayer-provenance-load_legacy_path = legacy compatibility world file "{ $name }"
main-singleplayer-provenance-load_asset = non-default asset "{ $asset }"
main-singleplayer-provenance-load_or_generate = managed world "{ $name }" ({ $overwrite })
main-singleplayer-provenance-overwrite-true = overwrite enabled
main-singleplayer-provenance-overwrite-false = overwrite disabled
main-singleplayer-legacy_gap-missing_typed_origin = Legacy metadata gap for this world: typed origin metadata unavailable
main-singleplayer-legacy_gap-missing_compat_audit = Legacy metadata gap for this world: compat audit missing
main-singleplayer-legacy_gap-missing_typed_origin_and_compat_audit = Legacy metadata gaps for this world: typed origin metadata unavailable; compat audit missing
main-singleplayer-legacy_gap-badge-missing_typed_origin = missing origin
main-singleplayer-legacy_gap-badge-missing_compat_audit = missing audit
main-singleplayer-legacy_gap-badge-missing_typed_origin_and_compat_audit = missing origin+audit
main-singleplayer-managed_recipe_sidecar_missing = Managed world loaded without an adjacent recipe sidecar; runtime recipe contract remains inferred from legacy option compare
main-singleplayer-managed_recipe_sidecar_missing-badge = missing sidecar
main-singleplayer-legacy_stock-total = Residual legacy worlds: { $legacy }
main-singleplayer-legacy_stock-unknown = unknown provenance: { $count }
main-singleplayer-legacy_stock-missing_typed_origin = typed origin metadata unavailable: { $count }
main-singleplayer-legacy_stock-missing_compat_audit = missing compat audit: { $count }
main-singleplayer-legacy_stock-sidecarless_managed_residual = sidecarless managed residual: { $count }
...
main-servers-world_compat_notice-load_legacy = A transitional world compatibility import path was used for this session: { $entry } was imported through explicit compatibility loading instead of the strict world file contract. { $remediation }
...
main-servers-world_compat_notice_remediation-load_legacy = If you want this world to keep starting after the legacy import path is retired, migrate it to a strict world file + sidecar contract before a future startup.
