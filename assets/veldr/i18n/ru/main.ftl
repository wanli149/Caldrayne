...
main-notice =
    Добро пожаловать в альфа-версию Caldrayne Online!
    ...
    - Если вы хотите оставить отзыв или сообщить об ошибке, используйте наш репозиторий GitHub.

    - Caldrayne Online - это проект с открытым исходным кодом. Это означает, что вы можете изменять и распространять игру в рамках лицензии GPL 3.

    - Caldrayne Online - это некоммерческий общественный проект, и все, кто работает над ним, являются добровольцами.
...
loading-tips =
    ...
    .a14 = Caldrayne Online все еще находится в Пре-Альфе. Мы делаем всё возможное, чтобы улучшать его каждый день!
    .a15 = Если вы хотите помочь разработке или поделиться отзывом, посетите наш репозиторий GitHub.
