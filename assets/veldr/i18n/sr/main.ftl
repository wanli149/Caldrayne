...
main-tip = Савет:
main-notice =
    Добродошао/ла у алфа верзију Caldrayne Online-а!
    ...
    - Ако имаш конструктивну повратну информацију или извештај о грешци, користи наш GitHub репозиторијум.

    - Caldrayne Online је лиценциран под GPL 3 лиценцом отвореног кода. Што значи да можеш да играш, мењаш, и раздељујеш игру како код пожелиш (ако је изведена дорада такође под GPL 3 лиценцом).

    - Caldrayne Online је не профитни пројекат заједнице, и сви који раде на њему су добровољци.
...
loading-tips =
    ...
    .a14 = Caldrayne Online је и даље Пре-Алфа. Сваким даном се трудимо да га побољшамо!
    .a15 = Ако желиш да помогнеш развоју или поделиш повратне информације, посети наш GitHub репозиторијум.
